...
def symbol_table():
    ...
    #내부에 __dict__를 확인하면 하당 객체 내부의 심볼 테이블 확인 가능

    # 사용자 정의 함수 func의 심볼 테이블을 확인
    #print(func.__dict__) -> 확인필요
...
def object_copy():
    ...
    # -> 얕은 복제: 새 객체를 만들지만 내부에 있는 요소의 주소 값들을 그대로 복제
