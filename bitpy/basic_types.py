...
def int_ex():
    ...
    #파이썬 3.x에서는 long, int 구분하지 않고 int처리
...
def math_functions():
    ...
    #특정 수치값을 만들 수있는
    #int, float, complex등의 함수

    #간단한 통계함수들은 지원
    scores = [80,90,70,60,100]
    print("죄저 점수(최솟값):", min(scores))
    print("죄고 점수(최댓값):", max(scores))
    print("합계:", sum(scores))
